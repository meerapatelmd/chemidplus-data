...
#' @format A data frame with 7729 rows and 3 variables:
#' \describe{
...
#' @title CONCEPT
#' @description DATASET_DESCRIPTION
#' @format A data frame with 6799 rows and 10 variables:
#' \describe{
...
#' @description DATASET_DESCRIPTION
#' @format A data frame with 206989 rows and 3 variables:
#' \describe{
#'   \item{\code{concept_id}}{character COLUMN_DESCRIPTION}
...
#' @description DATASET_DESCRIPTION
#' @format A data frame with 60364 rows and 4 variables:
#' \describe{
...
#' @description DATASET_DESCRIPTION
#' @format A data frame with 9764 rows and 11 variables:
#' \describe{
...
#' @description DATASET_DESCRIPTION
#' @format A data frame with 9587 rows and 4 variables:
#' \describe{
