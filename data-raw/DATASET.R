...
CONCEPT <- readr::read_csv('data-raw//CONCEPT.csv')
CONCEPT_ANCESTOR <- readr::read_csv('data-raw//CONCEPT_ANCESTOR.csv')
CONCEPT_RELATIONSHIP <- readr::read_csv('data-raw//CONCEPT_RELATIONSHIP.csv')
CONCEPT_SYNONYM <- readr::read_csv('data-raw//CONCEPT_SYNONYM.csv')
